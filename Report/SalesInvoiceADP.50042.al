report 50042 "Sales Invoice - AD - P"
{
    // <changelog>
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/SalesInvoiceADP.50042.rdl';
    ApplicationArea = all;
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(SalesInvoiceHeader_ExternalDocumentNo__; "Sales Invoice Header"."External Document No.")
                    {
                    }
                    column(SalesInvoiceHeader_OrderNo__; "Sales Invoice Header"."Order No.")
                    {
                    }
                    column(PageNumber__; CurrReport.PAGENO)
                    {
                    }
