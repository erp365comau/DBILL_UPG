report 50010 "Purchase Order - AD L"
{
    // <changelog>
    ...
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/PurchaseOrderADL.50010.rdl';
    ApplicationArea = all;
    Caption = 'Order';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(ShiptoAddress_1__; ShipToAddr[1])
                    {
                    }
                    column(ShiptoAddress_2__; ShipToAddr[2])
                    {
                    }
                    column(ShiptoAddress_3__; ShipToAddr[3])
                    {
                    }
                    column(ShiptoAddress_4__; ShipToAddr[4])
                    {
                    }
                    column(ShiptoAddress_5__; ShipToAddr[5])
                    {
                    }
                    column(PurchaseHeader_RequestedReaceiptDate__; "Purchase Header"."Requested Receipt Date")
                    {
                    }
                    column(txtCommentLine1__; txtCommentLine[1])
                    {
                    }
                    column(txtCommentLine2__; txtCommentLine[2])
                    {
                    }
                    column(txtCommentLine3__; txtCommentLine[3])
                    {
                    }
                    ...
                    column(RVVendor_Email__; RVVendor."E-Mail")
                    {
                    }
                    column(PurchaseHeader_ShiptoContact__; "Purchase Header"."Ship-to Contact")
                    {
                    }
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(PurchaseLine_VendorItemNo__; "Purchase Line"."Vendor Item No.")
                        {
                        }
            ...
            begin
                ...
                RecCommentLine.SETRANGE("Document Type", "Document Type");
                RecCommentLine.SETRANGE("No.", "No.");
                i := 0;
                IF RecCommentLine.FIND('-') THEN
                    REPEAT
                        Bool := TRUE;
                        i := i + 1;
                        txtCommentLine[i] := RecCommentLine.Comment;
                    UNTIL (RecCommentLine.NEXT <= 0) OR (i = 6);
    ...
    var
        ...
        RecCommentLine: Record "Purch. Comment Line";
        i: Integer;
        Bool: Boolean;
        txtCommentLine: array[6] of Text[250];
