report 50066 "Delivery Docket - AD P_Matrix"
{
    // <changelog>
    ...
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/DeliveryDocketADPMatrix.rdl';
    ApplicationArea = all;
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        column(SalesShipmentLine_VariantCode__; "Sales Shipment Line"."Variant Code")
                        {
                        }
