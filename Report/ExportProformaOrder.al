report 50096 "Export - Proforma - Order"
{
    // <changelog>
    ...
    // Austral Sugeevan 01/12/2014 >>> Removed Disc % Column, increased Description Column and print FJD if Currency Code is blank
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/ExportProformaOrder.rdl';
    ApplicationArea = all;
