report 50006 "Delivery Docket - AD - L"
{
    // <changelog>
    ...
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/DeliveryDocketADL.rdl';
    ApplicationArea = all;
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(SalesShipmentHeader_OrderNo__; "Sales Shipment Header"."Order No.")
                    {
                    }
                    column(SalesShipmentHeader_ShippingAgentCode__; "Sales Shipment Header"."Shipping Agent Code")
                    {
                    }
                    column(SalesShipmentHeader_ExternalDocumentNo__; "Sales Shipment Header"."External Document No.")
                    {
                    }
                    column(SalesShipmentHeader_SelltoContactNo__; "Sales Shipment Header"."Sell-to Contact No.")
                    {
                    }
