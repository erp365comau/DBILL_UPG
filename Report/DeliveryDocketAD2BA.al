report 50090 "Delivery Docket - AD 2 BA"
{
    // <changelog>
    ...
    // Austral Sugeevan 27/11/2015 >>> Print Sales Shipment Lines which has Outstanding Qty or Qty
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/DeliveryDocketAD2BA.rdl';
    ApplicationArea = all;
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        column(OutstandingQty_SalesShipmentLine__; "Outstanding Quantity")
                        {
                        }
