report 50004 "Statement - AD - P"
{
    // J2716 18Mar2013 LK - Design layout for a given format
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/StatementADP.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem(Integer; Integer)
            {
                ...
                column(BankBranch_CompanyInfo; CompanyInfo."Bank Branch No.")
                {
                }
                ...
                dataitem(CurrencyLoop; Integer)
                {
                    ...
                    dataitem(CustLedgEntryHdr; Integer)
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(DocType_DtldCustLedgEntries; DtldCustLedgEntries."Document Type")
                            {
                            }
                    ...
                    dataitem(CustLedgEntryFooter; Integer)
                    {
                        ...
                        column(DebitAmt_CustLedgEntryHdrFooter; DtldCustLedgEntries."Debit Amount")
                        {
                        }
                        column(CreditAmt_CustLedgEntryHdrFooter; DtldCustLedgEntries."Credit Amount")
                        {
                        }
                    }
                    dataitem(CustLedgEntry2; "Cust. Ledger Entry")
                    {
                        ...
                        column(DebitAmt_CustLedgEntry2; CustLedgEntry2."Debit Amount")
                        {
                        }
                        column(CreditAmt_CustLedgEntry2; CustLedgEntry2."Credit Amount")
                        {
                        }
