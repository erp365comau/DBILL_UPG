report 50089 "Sales Invoice - ADP V1.3 BA"
{
    // <changelog>
    ...
    // Austral Sugeevan 31/03/2015 >>> Added Delivery Docket No.
    // Austral Sugeevan 27/11/2015 >>> Print Sales Invoice Lines which has Outstanding Qty or Qty
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/SalesInvoiceADPV13BA.rdl';
    ApplicationArea = all;
    Caption = 'Sales Invoice - AD';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(TempSalesShptLine_DocumentNo__; TempSalesShptLine."Document No.")
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(VATAmtLineVATAmtText; VATAmountLine.VATAmountText2)
                        {
                        }
                        ...
                        column(OutstandingQty_SalesInvoiceLine__; "Outstanding Quantity")
                        {
                        }
                ...
                begin
                    IF Number > 1 THEN BEGIN
                        ...
                        OutputNo += 1;
                    END ELSE
                        IF "Sales Invoice Header"."No. Printed" >= 1 THEN
                            CopyText := Text003;//1
                    CurrReport.PAGENO := 1;
            ...
            begin
                ...
                CLEAR(UserName);
                User.SETFILTER("User Name", "Sales Invoice Header"."User ID");
                IF User.FIND('-') THEN
                    UserName := User."Full Name";

                //Austral Sugeevan 31/03/2015 >>>
                CLEAR(SalesInvLine);
