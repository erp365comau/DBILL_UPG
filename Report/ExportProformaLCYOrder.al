report 50097 "Export - Proforma LCY - Order"
{
    // <changelog>
    ...
    // Austral Sugeevan 16/10/2014 >>> RTC Layout Changes
    // Austral Sugeevan 26/10/2014 >>> Filter Sales Orders
    // Austral Sugeevan 01/12/2014 >>> Removed Disc % Column and increased Description Column
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/ExportProformaLCYOrder.rdl';
    ApplicationArea = all;
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyInfo; CompanyInfo."VAT Registration No.")
                    {
                    }
                    ...
                    column(SalesHeader_TransactionType__; "Sales Header"."Transaction Type")
                    {
                    }
                    column(ShippingMark_SalesHeader; "Sales Header"."Shipping Mark")
                    {
                    }
                    column(VesselNo_SalesHeader; "Sales Header"."Vessel No.")
                    {
                    }
                    column(VoyageNo_SalesHeader; "Sales Header"."Voyage No.")
                    {
                    }
                    column(SealNo_SalesHeader; "Sales Header"."Seal No.")
                    {
                    }
                    column(ContainerNo_SalesHeader; "Sales Header"."Container No.")
                    {
                    }
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(TotalAmountLCY__; TotalAmountLCY)
                        {
                        }
                        ...
                        begin
                            ...
                            TotalAmountLCY += SalesLine."Outstanding Amount (LCY)";//Austral Sugeevan 13/10/2014 <<<
                ...
                begin
                    ...
                    TotalAmountLCY := 0;//Austral Sugeevan 13/10/2014 <<<
                end;
    ...
    var
        ...
        Text003: Label ' COPY';
        Text004: Label 'EXPORT INVOICE %1';
