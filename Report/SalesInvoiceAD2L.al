report 50058 "Sales Invoice - AD 2 L"
{
    // <changelog>
    ...
    // </changelog>
    // 
    // J2716 01Mar2013 LK - Modify as per given format
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/SalesInvoiceAD2L.rdl';
    ApplicationArea = all;
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompInfo3Picture; CompanyInfo3.Picture2)
                    {
                    }
                    column(CompInfo2Picture; CompanyInfo2.Picture2)
                    {
                    }
                    column(CompInfo1Picture; CompanyInfo1.Picture2)
                    {
                    }
                    column(CompInfoPicture; CompanyInfo.Picture2)
                    {
                    }
    ...
    begin
        ...
        CompanyInfo2.CALCFIELDS(Picture2);
        CompanyInfo3.CALCFIELDS(Picture2);
        // << J2716
    end;
