report 50063 "Sales-Credit Memo-AD P_Matrix"
{
    // <changelog>
    ...
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/SalesCreditMemoADPMatrix.rdl';
    ApplicationArea = all;
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        column(SalesCreditMemoLine_VariantCode__; "Sales Cr.Memo Line"."Variant Code")
                        {
                        }
