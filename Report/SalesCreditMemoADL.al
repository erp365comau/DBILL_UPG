report 50003 "Sales - Credit Memo - AD - L"
{
    // <changelog>
    ...
    //     </change>
    // </changelog>
    // 0.01 Austral Sugeevan 22/02/2013 --> J2716 --> RTC Design Change same as Southland Company Reports
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/SalesCreditMemoADL.rdl';
    ApplicationArea = all;
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(SelltoCustNo_SalesCrMemoHdr2__; "Sales Cr.Memo Header"."Sell-to Customer No.")
                    {
                    }
