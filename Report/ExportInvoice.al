report 50091 "Export - Invoice"
{
    ...
    // </changelog>
    // 
    // J2716 13Mar2013 LK - Modify as per given format
    // J2716 16 May 2013 -JJ - Added Currency Code and Change the Currency Symble If the currency Code on the document is blank or AUD, then symbol $ will be used.
    // J3249 Austral Sugeevan 26/06/2013 --> Done Format Changes
    // Austral Sugeevan 13/10/2014 >>> RTC Layout Changes
    // Austral Sugeevan 13/11/2014 >>> RTC Layout Mods
    // 
    // 0.01 Austral Jozef 23.03.2015 - Hide payment bank details box
    // Austral Sugeevan 18/11/2015 >>> RTC Layout Mods and Print 'FJD' when Currency Code is blank and Gross Weight Mods
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/ExportInvoice.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(ShipmentDate_SalesInvHeader; "Sales Invoice Header"."Shipment Date")
            {
            }
            column(ShippingAgentCode_SalesInvHeader; "Sales Invoice Header"."Shipping Agent Code")
            {
            }
            column(SelltoContact_SalesInvHeader; "Sales Invoice Header"."Sell-to Contact")
            {
            }
            column(QuoteNo_SalesInvHeader; "Sales Invoice Header"."Quote No.")
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(DocumentDate04_SalesInvHeader; "Sales Invoice Header"."Posting Date")
                    {
                    }
                    ...
                    column(SalesInvoiceHeader_TransactionType__; "Sales Invoice Header"."Transaction Type")
                    {
                    }
                    column(ShippingMark_SalesInvoiceHeader; "Sales Invoice Header"."Shipping Mark")
                    {
                    }
                    column(VesselNo_SalesInvoiceHeader; "Sales Invoice Header"."Vessel No.")
                    {
                    }
                    column(VoyageNo_SalesInvoiceHeader; "Sales Invoice Header"."Voyage No.")
                    {
                    }
                    column(SealNo_SalesInvoiceHeader; "Sales Invoice Header"."Seal No.")
                    {
                    }
                    column(ContainerNo_SalesInvoiceHeader; "Sales Invoice Header"."Container No.")
                    {
                    }
                    column(Area_SalesInvoiceHeader; "Sales Invoice Header".Area)
                    {
                    }
                    column(ExitPoint_SalesInvoiceHeader; "Sales Invoice Header"."Exit Point")
                    {
                    }
                    ...
                    column(User_FullName__; User."Full Name")
                    {
                    }
                    column(PromisedDeliveryDate_SalesInvoiceHeader; "Sales Invoice Header"."Promised Delivery Date")
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(DVVATAmount; DVVATAmount)
                        {
                        }
                        column(OutstandingQuantity_SalesInvoiceLine; "Outstanding Quantity")
                        {
                        }
                        column(GrossWeightSum__; GrossWeightSum)
                        {
                        }
                        ...
                        begin
                            ...
                            // >> J2716
                            DVVATAmount := "Amount Including VAT" - Amount;
                            // << J2716
                        end;
                        ...
                        begin
                            ...
                            CLEAR(GrossWeightSum);
                            SalesInvLine.SETRANGE("Document No.", "Document No.");
                            IF SalesInvLine.FINDSET THEN
                                REPEAT
                                    GrossWeightSum += SalesInvLine."Gross Weight";
    ...
    var
        ...
        Text003: Label 'COPY';
        Text004: Label 'EXPORT COMMERCIAL INVOICE %1';
        ...
        DVVATAmount: Decimal;
        FooterText001: Label 'Subject to terms and conditions available upon request.';
        FooterText002: Label 'This is a payment claim under the building & construction industry security of paymment act 1999.';
        User: Record User;
