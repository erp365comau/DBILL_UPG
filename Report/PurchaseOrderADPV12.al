report 50082 "Purchase Order - AD PV 1.2"
{
    // <changelog>
    ...
    //     </change>
    // </changelog>
    // Austral Sugeevan 12/11/2014 >>> Print G/L Account No and RTC Layout Mods
    // Austral Sugeevan 05/03/2015 >>> Added a Footer Text - "This is a computer generated Invoice, Signature not required."
    // Austral Lakshan 23/05/2017 >>> Avoid printing same name in PO (J9404)
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/PurchaseOrderADPV12.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            begin
                ...
                //J9404 >>>
                IF BuyFromAddr[1] = BuyFromAddr[2] THEN
                    BuyFromAddr[2] := '';
                //J9404 <<<
