report 50014 "Payment Voucher - AD"
{
    // Austral Sugeevan 30/09/2014 >>> RTC Layout Mods
    // Austral Sugeevan 09/10/2014 >>> Amount (LCY) Mods
    // Austral Sugeevan 15/10/2014 >>> Amount (LCY) Mods
    // Austral Sugeevan 08/03/2015 >>> Added an option to group by Document No. in Request Page and Grouping by Document No.
    // Austral Sugeevan 19/11/2015 >>> RTC Layout Mods and Print Totals depending on GroupByDocumentNo field
    // J11511 20180910 LK - LAYOUT FOOTER TEXT CHANGE
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/PaymentVoucherAD.rdl';
    ApplicationArea = all;
    Caption = 'Payment Voucher - AD';
    ...
    dataset
    {
        dataitem(VoidGenJnlLine; "Gen. Journal Line")
        {
            ...
            begin
                //CheckManagement.VoidCheck(VoidGenJnlLine);//1
            end;
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            column(AppliestoID_GenJnlLine; "Applies-to ID")
            {
            }
            ...
            column(Description2_GenJnlLine; Description2)
            {
            }
            column(CurrencyFactor_GenJnlLine; "Currency Factor")
            {
            }
            column(GroupByDocumentNo__; GroupByDocumentNo)
            {
            }
            column(BankAccountTotal__; BankAccountTotal)
            {
            }
            ...
            dataitem(CheckPages; Integer)
            {
                ...
                column(CheckToAddr_2__; CheckToAddr[2])
                {
                }
                column(CheckToAddr_4__; CheckToAddr[4])
                {
                }
                column(CheckToAddr_3__; CheckToAddr[3])
                {
                }
                column(CheckToAddr_5__; CheckToAddr[5])
                {
                }
                dataitem(PrintSettledLoop; Integer)
                {
                    ...
                    column(DescriptionText__; DescriptionText)
                    {
                    }
                    column(PostingDate__; PostingDate)
                    {
                    }
                    column(TotalLineAmount__; TotalLineAmount)
                    {
                    }
                    column(TotalLineAmount2__; TotalLineAmount2)
                    {
                    }
                    ...
                    begin
                        IF NOT TestPrint THEN BEGIN
                                            ...
                                            CASE BalancingType OF
                                                BalancingType::Customer:
                                                    BEGIN
                                                        ...
                                                        CustLedgEntry.FIND('-');
                                                        CustUpdateAmounts(CustLedgEntry, RemainingAmount);//1L
                                                    END;
                                                ...
                                                CASE BalancingType OF
                                                    BalancingType::"G/L Account":
                                                        BEGIN
                                                            ...
                                                            LineAmount := CurrentLineAmount;
                                                            LineDiscount := 0;
                                                            PostingDate := GenJnlLine2."Posting Date";//1
                                                            DescriptionText := GenJnlLine2.Description;//1
                                                        END;
                                                    BalancingType::Customer:
                                                        BEGIN
                                                            CustLedgEntry.RESET;
                            ...
                            TotalLineAmount2 := TotalLineAmount2 + LineAmount;
                            TotalLineDiscount := TotalLineDiscount + LineDiscount;
                        END ELSE BEGIN
                            IF FoundLast THEN
                                CurrReport.BREAK;
                ...
                dataitem(PrintCheck; Integer)
                {
                    ...
                    var
                        Decimals: Decimal;
                    begin
                        //CurrReport.BREAK;//Austral Sugeevan 01/10/2014
                        IF NOT TestPrint THEN BEGIN
                            WITH GenJnlLine DO BEGIN
                                ...
                                //CheckManagement.InsertCheck(CheckLedgEntry);//1
                                ...
                                IF FoundLast THEN BEGIN
                                    ...
                                    ELSE
                                        CheckAmountText := FORMAT(CheckLedgEntry.Amount, 0, 0);
                                    FormatNoText(DescriptionLine, CheckLedgEntry.Amount, BankAcc2."Currency Code");//SSLAST
                                    VoidText := '';
                                END ELSE BEGIN
                ...
                begin
                    IF NOT TestPrint THEN BEGIN
                        ...
                        END ELSE BEGIN
                            ...
                            //1GenJnlLine3.VALIDATE("Account No.",BankAcc2."No.");//1
            ...
            begin
                ...
                IF NOT TestPrint THEN BEGIN
                    ...
                    //TESTFIELD("Bal. Account Type","Bal. Account Type"::"Bank Account");//1
                    //IF "Bal. Account No." <> BankAcc2."No." THEN//1
                    //CurrReport.SKIP;//1
            ...
            begin
                ...
                IF NOT TestPrint THEN BEGIN
                    ...
                    //BankAcc2."No." := GenJnlLine."Bank Account No.";
                    //BankAcc2.GET(BankAcc2."No.");//1
                    //BankAcc2.TESTFIELD(Blocked,FALSE);//1
                    COPY(VoidGenJnlLine);
                    //SETRANGE("Bank Payment Type","Bank Payment Type"::"Computer Check");//1
                    //SETRANGE("Check Printed",FALSE); //1
                END ELSE BEGIN
                    CLEAR(CompanyAddr);
                    FOR i := 1 TO 5 DO
                ...
                IF FIND('-') THEN
                    GenJnlLine.FIELDERROR("Account Type");//1
                SETRANGE("Account Type");

                //Austral Sugeevan 19/11/2015 >>>
                IF GroupByDocumentNo THEN BEGIN
                    ...
                    IF GenJournalLine.FINDSET THEN
                        REPEAT
                            BankAccountTotal += GenJournalLine.Amount;
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(GroupByDocumentNo; GroupByDocumentNo)
                    {
                        Caption = 'Group By Document No.';
                        ApplicationArea = All;
                    }
                }
            }
    ...
    var
        ...
        GroupByDocumentNo: Boolean;
        BankAccountTotal: Decimal;
    ...
    begin
        ...
        PostingDate := VendLedgEntry2."Posting Date";
        DescriptionText := VendLedgEntry2.Description;
