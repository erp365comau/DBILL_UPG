report 50041 "Purchase Order - AD - P"
{
    // <changelog>
    ...
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/PurchaseOrderADP.50041.rdl';
    ApplicationArea = all;
    Caption = 'Purchase Order - AD';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(TVShippingAgentDescription__; TVShippingAgentDescription)
                    {
                    }
            ...
            begin
                ...
                CLEAR(RVShippingAgent);
                CLEAR(TVShippingAgentDescription);
                RVShippingAgent.SETRANGE(Code, "Shipping Agent Code");
                IF RVShippingAgent.FIND('-') THEN
                    TVShippingAgentDescription := RVShippingAgent.Name;

                CLEAR(RVShippingAgentServices);
                CLEAR(TVShippingDescription);
                RVShippingAgentServices.SETRANGE(Code, "Shipping Agent Service");
                IF RVShippingAgentServices.FIND('-') THEN BEGIN
                    TVShippingDescription := RVShippingAgentServices.Description;
                    TVShippingAgentDescription := TVShippingAgentDescription + ' & ' + TVShippingDescription;
                END;
    ...
    var
        ...
        RVShippingAgent: Record "Shipping Agent";
        TVShippingAgentDescription: Text[60];
        RVShippingAgentServices: Record "Shipping Agent Services";
        TVShippingDescription: Text[60];
