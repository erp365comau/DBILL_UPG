report 50026 "Delivery Docket - AD BA"
{
    // <changelog>
    ...
    // Austral Sugeevan 04/03/2015 >>> Fixed Issues and Footer Mods in RTC Layout
    // Austral Sugeevan 06/03/2015 >>> Fixed Issue on printing two pages
    // Austral Sugeevan 28/04/2015 >>> Fixed Issue on printing two pages for some Delivery Dockets on either Sell to Customer and Bill to Customer are same or not
    // J10148 20171031 LK - ADD NET WEIGHT TO REPORT
    // J15698 Austral Sugeevan 11/05/2021 >>> Skip Quantity 0 Lines
    // 
    // ECKK
    // ----
    //   18-10-22
    //   EC1.00 Added Item Code on Layout
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/DeliveryDocketADBA.rdl';
    ApplicationArea = all;
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyInfoIRDNo; CompanyInfo."IRD No.")
                    {
                    }
                    ...
                    column(ShptHeaderPostingDate; "Sales Shipment Header"."Posting Date")
                    {
                    }
                    ...
                    column(SalesShipmentHeader_BilltoCity; "Sales Shipment Header"."Bill-to City")
                    {
                    }
                    column(CustAddr1__; CustAddr[1])
                    {
                    }
                    column(CustAddr2__; CustAddr[2])
                    {
                    }
                    column(CustAddr3__; CustAddr[3])
                    {
                    }
                    column(CustAddr4__; CustAddr[4])
                    {
                    }
                    column(CustAddr5__; CustAddr[5])
                    {
                    }
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        begin
                            ...
                            //J15698 Austral Sugeevan 11/05/2021 >>>
                ...
                begin
                    IF Number > 1 THEN BEGIN
                        ...
                        OutputNo += 1;
                    END ELSE
                        IF "Sales Shipment Header"."No. Printed" >= 1 THEN
                            CopyText := Text001;//1
                    CurrReport.PAGENO := 1;
            ...
            begin
                ...
                IF SalesShipmentLine.FINDFIRST THEN
                    REPEAT
                        ...
                        //J10148---------------->>>
                        NetWeight := NetWeight + (SalesShipmentLine.Quantity * SalesShipmentLine."Net Weight");
                    //J10148----------------<<<
    ...
    var
        ...
        Text001: Label 'COPY';
        Text002: Label 'Delivery Docket %1';
