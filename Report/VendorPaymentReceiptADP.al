report 50005 "Vendor Payment Receipt - AD-P"
{
    // <changelog>
    //   <change id="PS38806" dev="navodit" date="2009-06-05" area="WHT" releaseversion="AP6.00.01" feature="NAVCORS38806">
    //     Code added to solve Vendor Payment Receipt is not correctly reflecting payable amount.
    //   </change>
    // </changelog>
    // J2716 19Mar2013 LK  design layout for given format
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/VendorPaymentReceiptADP.rdl';
    ApplicationArea = all;
    Caption = 'Vendor Payment Receipt - AD';
